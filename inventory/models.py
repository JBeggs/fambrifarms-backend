...
class RawMaterialBatch(models.Model):
    ...
    # supplier = models.ForeignKey('suppliers.Supplier', on_delete=models.CASCADE)  # Simplified for now
    supplier_name = models.CharField(max_length=200, default='Pretoria Market')
