...
urlpatterns = [
    ...
    path('suppliers/', views_procurement.get_all_suppliers, name='get_all_suppliers'),
    ...
    path('procurement/recommendations/<int:recommendation_id>/items/<int:item_id>/supplier/', views_procurement.update_procurement_item_supplier, name='update_procurement_item_supplier'),
    path('procurement/recommendations/<int:recommendation_id>/bulk-supplier-update/', views_procurement.bulk_update_procurement_suppliers, name='bulk_update_procurement_suppliers'),
