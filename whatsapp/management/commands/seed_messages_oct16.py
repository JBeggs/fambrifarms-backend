"""
Django management command to seed WhatsApp messages for October 16, 2025
"""
...
class Command(BaseCommand):
    help = 'Seed WhatsApp messages for October 16, 2025 (Wednesday)'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS('🗓️  Seeding messages for Wednesday, October 16, 2025'))
        ...
        json_file = 'Wednesday_16_10_2025_messages.json'
        ...
        try:
            ...
            for msg_data in messages_data:
                try:
                    ...
                    # Parse timestamp - handle WhatsApp format: "07:45, 10/16/2025"
                    timestamp_str = msg_data.get('timestamp', '')
                    if timestamp_str:
                        try:
                            # Parse WhatsApp format: "07:45, 10/16/2025"
                            if ', ' in timestamp_str:
        ...
        self.stdout.write(self.style.SUCCESS('\n✅ October 16, 2025 seeding completed!'))
